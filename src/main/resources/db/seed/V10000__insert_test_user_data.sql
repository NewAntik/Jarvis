-- Users
INSERT INTO users (rnokpp, sex, illegal_actions, created_date, updated_date, individual_entrepreneur)
VALUES
    ( '1234567890', 'MALE', 'Протиправна діяльність №199', '2023-01-01 10:00:00', '2023-01-01 10:00:00', 'UNKNOWN'),
    ( '7890654321', 'MALE', 'Протиправна діяльність №200', '2023-01-02 10:00:00', '2023-01-02 10:00:00', 'UNKNOWN'),
    ( '1112225555', 'MALE', NULL, '2023-01-03 10:00:00', '2023-01-03 10:00:00', 'UNKNOWN'),
    ( '3334448888', 'FEMALE', NULL, '2023-01-04 10:00:00', '2023-01-04 10:00:00', 'UNKNOWN'),
    ( '5556660945', 'FEMALE', NULL, '2023-01-05 10:00:00', '2023-01-05 10:00:00', 'UNKNOWN'),
    ( '5223360630', 'FEMALE', NULL, '2023-01-05 10:00:00', '2023-01-05 10:00:00', 'UNKNOWN'),
    ('5523360645', 'FEMALE', NULL, '2023-01-05 10:00:00', '2023-01-05 10:00:00', 'UNKNOWN');

INSERT INTO user_first_names(user_id, value, created_date, updated_date)
VALUES
    (1, 'Іван','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Тарас','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Денис','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Валерій','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (3, 'Григорій','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (4, 'Катирина','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (5, 'Марта','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (6, 'Зінаїда','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (7, 'Аргентіна','2023-01-01 10:00:00', '2023-01-01 10:00:00');

INSERT INTO user_sur_names(user_id, value, created_date, updated_date)
VALUES
    (1, 'Іванович','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Шевченко','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Іванов','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Карташов','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (3, 'Шевченко','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (4, 'Шевченко','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (5, 'Шевченко','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (6, 'Шевченко','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (7, 'Шевченко','2023-01-01 10:00:00', '2023-01-01 10:00:00');

INSERT INTO user_middle_names(user_id, value, created_date, updated_date)
VALUES
    (1, 'Іванович','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Григорович','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Денисович','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (2, 'Генадієвич','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (3, 'Іванович','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (4, 'Якимівна','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (5, 'Іванівна','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (6, 'Олеговна','2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    (7, 'Енакентієвна','2023-01-01 10:00:00', '2023-01-01 10:00:00');
