...
public class NameAndSurNameExecutorImplService implements CommandExecutorService {
	...
	public ExecutorType getType() {
		return ExecutorType.SURNAME_AND_NAME;
	}
	...
	private UserCriteria createCriteria(final String surName, final String name) {
		return new UserCriteria.UserCriteriaBuilder().surName(surName).name(name).build();
	}
}
